...
GO
INSERT [dbo].[Local] ([id_local], [nm_local], [cidade], [estado], [cisp], [risp], [aisp], [ocorrencias], [id_delegacia], [id_batalhao], [id_risco], [dt_atualizacao], [dt_cadastro]) VALUES (2, N'Bangu', N'Rio de Janeiro', N'RJ', N'123', N'123', N'123', N'2 ocorrências de assalto', 1, 1, 1, NULL, CAST(N'2021-02-20T14:38:46.727' AS DateTime))
GO
INSERT [dbo].[Local] ([id_local], [nm_local], [cidade], [estado], [cisp], [risp], [aisp], [ocorrencias], [id_delegacia], [id_batalhao], [id_risco], [dt_atualizacao], [dt_cadastro]) VALUES (3, N'Realengo', N'Rio de Janeiro', N'RJ', N'345', N'125', N'412', N'3 Assaltos por dia.', 2, 2, 1, CAST(N'2021-02-20T15:09:54.320' AS DateTime), CAST(N'2021-02-20T14:56:37.787' AS DateTime))
GO
...
GO
INSERT [dbo].[Inspecao] ([id_inspecao], [distanciaComunidade], [motivoReprovacao], [nota], [situacao], [fotoPredio], [fotoApartamento], [id_cliente], [id_predio], [id_apartamento], [id_local], [id_notaMeioProtecaoTecnico], [id_notaMeioProtecaoFisico], [id_notaAvaliacaoProcedimento], [id_notaMeioProtecaoHumano], [dt_cadastro]) VALUES (1, N'2KM', N'Meio Proteção Fisico Meio Proteção Tecnico, ', CAST(50 AS Decimal(18, 0)), N'Reprovada', N'FP20022021144312.png', N'FA20022021144312.png', 1, 1, 1, 2, 1, 1, 1, 1, CAST(N'2021-02-20T14:43:12.813' AS DateTime))
GO
INSERT [dbo].[Inspecao] ([id_inspecao], [distanciaComunidade], [motivoReprovacao], [nota], [situacao], [fotoPredio], [fotoApartamento], [id_cliente], [id_predio], [id_apartamento], [id_local], [id_notaMeioProtecaoTecnico], [id_notaMeioProtecaoFisico], [id_notaAvaliacaoProcedimento], [id_notaMeioProtecaoHumano], [dt_cadastro]) VALUES (2, N'4KM', N'', CAST(92 AS Decimal(18, 0)), N'Aprovada', N'FP20022021151116.jpeg', N'FA20022021151116.png', 2, 2, 2, 3, 4, 4, 4, 4, CAST(N'2021-02-20T15:11:16.833' AS DateTime))
GO
